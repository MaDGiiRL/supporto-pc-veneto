...
<script>
    ...
    (() => {
        ...
        tabs.forEach(t => t.addEventListener('click', () => setActive(t.dataset.sorCatTab)));

        // init: usa tab già attivo o il primo
        const init = tabs.find(t => t.classList.contains('is-active'))?.dataset.sorCatTab || tabs[0].dataset.sorCatTab;
        setActive(init);
    })();
</script>