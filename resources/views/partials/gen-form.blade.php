<form id="form-ev" class="grid grid-cols-1 md:grid-cols-2 gap-4">
    @csrf
    ...
    <div class="grid gap-1.5">
        ...
        <div class="flex items-center gap-4">
            <label class="inline-flex items-center gap-2">
                <input type="radio" name="verso" value="E" checked> Entrata (E)
            </label>
            <label class="inline-flex items-center gap-2">
                <input type="radio" name="verso" value="U"> Uscita (U)
            </label>
        </div>
    </div>
    ...
    <label class="grid gap-1.5 md:col-span-2">
        ...
        <p class="text-xs opacity-70">
            Clicca sulla mappa per impostare la posizione. Trascina il marker (se hai i permessi).
        </p>

        <div class="flex flex-wrap items-center gap-2 mb-2">
            <button type="button" class="btn btn-xs" id="ev-use-my-location">📍 Usa la mia posizione</button>
            <span class="text-[11px] opacity-70">Verrà usata solo la posizione corrente del browser.</span>
        </div>
        ...
        <p class="mt-1 text-[11px] opacity-70">Le coordinate vengono salvate solo se presenti.</p>
    </label>
